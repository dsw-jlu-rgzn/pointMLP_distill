...
from models.hook_feature import FeatureExtraction, FeatureXyzExtraction, FeatureXyzExtractionST, \
    MultiFeatureXyzExtractionST, GradCAM, GradCAMST
import wandb
...
def main():
    ...
    elif args.kd_mode == "grad":
        # layer_name_s = "module." + "pos_blocks_list.3.operation.0.net2"
        # layer_name_t = "module." + "pos_blocks_list.3.operation.1.net2"
        xyz_s = "module." + "local_grouper_list.3"
        xyz_t = "module." + "local_grouper_list.3"
        layer_name_s = get_last_conv_name(net_s)
        layer_name_t = get_last_conv_name(net_t)
        FExtract = GradCAMST(net_s, net_t, layer_name_s, layer_name_t, xyz_s, xyz_t)
        criterionKD = Hint()
    if args.AddST == True:
